...
Keeping Athas Interesting and
Unique

Athas is intended to work differently
than other traditional fantasy worlds,
even after taking into account that it is a
post-apocalyptic setting. Exotic plants,
weird animals and unique landscapes
dot the world of Dark Sun, so DMs
should play with imaginative
descriptions for the locations the PCs
get to explore, for example by describing
colorful flowers growing on the walls of
a canyon, or exotic colors of boulders on
the rocky badlands, all of these will
provide PCs the feeling that the world
they are in is different and mysterious,
and even if Athas is a harsh deadly
planet, it is still beautiful and could even
...
landscapes and phenomena that will go
beyond the imagination of many.
Providing Challenges from the
Environment
...
not have enough water and food to go
back safely to the nearest settlement. All
of these make the world gritty and
challenging, and without dropping a
single monster on the table, tension
would be always high and every decision
could mean life or death.

Resource Management

Because survival is a key aspect when
having adventures in Athas, DMs must
make sure to keep track of the items
carried by the PCs, with the amount
waterskins and rations reminded, all
arrows counted, and the breakage of
armor and weapons joining together to
entice players to get creative and use
every trick at their disposal to live
another day.
...
1. Protect Home Base/City

The city or settlement the PCs are in is
facing outside threats that could cause
its destruction. The PCs are employed by
one or more factions inside the base to
deal with these threats one way or the
other to ensure the safety of their home.
2. Veiled Alliance operations
The Veiled Alliance is attempting to
promote its plans to undermine the
Sorcerer Kings, avoid persecution or take
down traitors and enemies. PCs will have
to work through operatives with code
words, fear that templars could find
them at any turn and may be forced to
deal with shady organizations where
right and wrong can blur together.

3. Restore Athas

The PCs must help a druid or cleric to
defend or expand a natural formation
against a defiling force, which can be
defilers, a dangerous beast or an evil
artifact.

4. Become Employees for a
Merchant House

The PCs are employed by a Merchant
...
The PCs are employed by a noble house
or templar to undermine political
opponents, taking part in assassinations,
backstabbing and many potential
situations with morally questionable
implications.

6. Gladiator Combat

The PCs are pit fighters (maybe even
slaves), participating in gladiator
combat, fighting in tournaments against
powerful and cunning opponents in
front of bloodthirsty audiences, either
for glory, wealth or their freedom.

7. Take part in Intercity War
PCs are part of a City-State’s army and
must participate in military battles and
operations to earn victory and wealth in
the name of a Sorcerer-King.

8. Dethrone a Sorcerer-King
The PCs join or maybe even lead a
rebellion against an evil Sorcerer-King,
gaining allies and enemies and
eventually taking part in a final battle for
...
XP in the Dark Sun setting may be
gained from four sources: treasure
recovered, monsters defeated, resources
acquired and class related actions
(optional).
...
The value of XP: Characters gain 1 XP
...
slain, outsmarted, captured, scared away,
etc.) grant XP based on how powerful
they are. Similar to how it works in Old
School Essentials™ and other B/X
based games.
...
Water Source: Water accounts for 50
XP x Number of days it lasts. If an
Oasis or other significant body of water
is discovered, it is worth up to 2,000 XP.

Food Source: Food accounts for 25 XP x
Number of days it is able to feed one
person.

Place for Shelter: Finding a good place
to take refuge is worth 20 XP x number
of days it was used or safe.

Class Action (Optional Rule)

Experience may be granted by the use of

class or race abilities that follow the
...
Prowess (50 xp per level).

> Gladiator:Taking the final hit on a
foe (100 XP).

> Ranger: Performing Survival Tasks
(100 XP).

> Cleric: Promoting Elemental Patrons
(100 XP).
...
> Preserver: Maintaining Spell’s
secrecy (100 XP).

> Defiler: Defiling the land (50 XP per
level).

> Thief: Thieving skill successful use
(20 XP per level).

> Bard: Effective use of poison (100
XP).

> Psionicist: Using psionics to solve

problems (40 XP per level).

Dwarf: Complete Focus (300 XP).

Elf: Promote tribe's well being (20 XP

per level).

> Halfling: Practice another race
culture (50 XP).

> Half-Elf: Better a human or elf in
their customs (150 XP).

> Half-Giant: Shift alignment (100
XP).

> Mul: Show strength or resistance
(50XP).

> Thri-kreen: Perform hunt (100 XP).
...
Ina world of survival, characters may
...
adventuring present in Old School
Essentials™.
...
2. Losing direction: The DM determines
whether the party gets lost.

3. Upcoming Obstacles: The DM makes
checks for monsters and weather.

4. Description: The DM describes the
terrain passed through and any sites of
interest that the party comes across,
asking players for their actions, as
required. If a monster is determined to
appear, it may happen at any time during
this step.

5. Survival Tasks: The players may
choose to attempt a task related for
survival, they must make a check to
determine success or failure in such
actions.

6. End of day: The DM updates time
records, with special attention to rations,
spell durations, and the party's need to
rest.

Overland Travel

Terrain Modifiers Some types of terrain
modify the speed at which characters
can travel:
e Broken lands, desert, salt flats, :
33% slower.
e Jungle, mountains, salt marshes:
50% slower.
...
Water Consumption
An active character (hard exertion,
...
CON drops to o, the character dies.

Recovering from Starvation
A character suffering from the effects of
starvation able to find food and water to
survive may recover slowly. The
recovering character regains 1d8 CON
each subsequent day they receive food
and water once more (assuming the
character is safe from starvation), until it
regains its original CON score.
...
Survival tasks are downtime activities
that may be attempted during
wilderness travel. These actions will
require a check to determine success or
failure.

Survival check: Unless otherwise
stated, all survival checks have a chance
of 1-in-6 of success.

Survival Tasks Descriptions

Pathfinding

It allows the character to look for the
right path to their destination if they are
currently lost in direction.

Gear Repairing

The character sharpens weapons and
armor. A Broken weapon or armor is
repaired on a success. Only one piece of
gear may be repaired at a time, an metal
...
the DM. Ona success, the wounded
...
Foraging for herbs, fruits, nuts, etc. Ona
success, the character finds 1d4 food
units, medicinal herbs or 1d4 water
units.

Treating Illness

The character may treat illnesses,
provided they have proper remedies or
other required objects set by the DM.
On a success, the character treats status
ailments like poison, paralysis or
diseases (assuming they can be cured).

Gear Crafting

The character is able to create a weapon
or armor, assuming the character has the
necessary materials to craft one. This is a
long and complicated process, especially
in the wilderness, therefore multiple
successful attempts are required to
create a weapon or armor. The following
table describes the amount of attempts
necessary depending on the material for
armor or weapons.
...
*: Steel Weapons can only be crafted in
specialized almost nonexistent forges.
...
Every city state has its own calendar, but
that most commonly used and
considered the Calendar of Tyr.

In the calendar of Tyr, years are counted
off using a pair of concurrently running
cycles; one of eleven parts, the other of
seven. The eleven-part, or endlean cycle,
is counted and spoken first, in the order
presented below. The seven-part, or
seofean cycle, is counted and spoken
second. The endlean cycle is complete
when Athas two moons, Ral and Guthay,
meet in the heavens in a major eclipse
that occurs once every 11 years. The
seofean cycle is more abstract, meeting
when agitation in the cosmos leads to
fury. Every 77 years the cycle repeats
itself, ending with a year of Guthay’s
Agitation and starting again with a new
year of Ral’s Fury. Each 77-year cycle is
called a king’s age; there have been 183
complete king’s ages since Tyr adopted
this calendar (more than 14,500 years).
...
marked difference in temperature or
weather patterns. However, the year is
divided into three equal phases: high
sun, sun descending, and sun ascending.
Highest sun is the first day of the year in
the calendar of Tyr and lowest sun
indicates the midpoint of the year
(which, incidentally, occurs at midnight,
and is generally observed in night time
ceremonies).

Year of the Messenger

Every 45 years, a brilliant comet visits Athas.
By night one can read by the messenger’s
light, and it can be seen clearly in the full
light of day. Folklore

holds that the messenger visits the dragon
every 45 years to deliver to him important
...
For campaign purposes, the calendar starts
on High Sun (the first day of the year) of the
Year of Priest’s Defiance, in the 170th King’s
Age. The next Year of the Messenger will be
...
scarce, and the kings scheming with
each other for control over the
Tablelands, armies are raised almost
daily in the city-states, villages and
marauding tribes on the desert, leaving
the world either waging war or
preparing for the next one. For these
reasons, the PCs may be involved in
battles, and the following rules may be
used to manage them.

When is Mass Combat used?

It could be used anytime as the DM sees
fit, but as a rule of thumb, any hostile
encounter where each of two or more
sides have at least 50 creatures on
their side may be required to use mass
combat.

Army Organization

Armies need to be organized to be
effective, so the following are ways that
any army may be organized.

Units:

A group of 5-10 men form a unit, the
most basic division of any army. These
determine the battle rating of an army
and may be joined together. Units range
between many types of specializations,
depending on the type of individuals
that form them.

Centuria:

A group of 5-10 units form a centuria,
they are the most common subdivision
of an army, as they are the ones that
tend to reach the middle ground of
flexibility and strength in numbers to be
effective. A group of centuriae operating

together in conjunction is known as a
Legion.
...
A Unit's amount Hit Points is
determined by the table on the next
page. When units form a centuria, the
hit points of each unit are added
together.

Battle Rating (br)

A Unit battle rating is a bonus
representing offense and defense during
combat. When different types of units
form a centuria, the centuria battle
rating is determined by the unit with the
highest battle rating.

Movement Rate

The speed at which units may move on
the battlefield. When different units
form a centuria, the movement rate is
determined by the unit with the lowest
movement rate.

Morale

Morale is the capacity of an army to
maintain cohesion and belief in victory.
When different units form a centuria,
the morale is determined by the unit
with the highest morale.

Battle Rank (Optional Rules)

Battle rank is a badge of veterancy, to
gain one up, units or centuriae must
defeat at least one enemy unit or
centuria and survive a battle without
retreating. Ranks are written in roman
numbers from 1 to 3 (I-III) and grant an
extra point of battle rating per rank.
Battle Formations

Special stances that units may take that
modify their stats, usable depending on
the situation. Battle formations are only
available for centuriae composed of the
same type of unit.
...
Arm/Disarm: The unit is able to mount
and dismount barricades, siege
machines and traps, taking 1d4 turns to
mount or dismount them.

Berserk: Increases the morale and

battle rating of the unit by 1 for one turn.

Charge: The unit moves at double its
movement rate, but at the cost of having
-1 to its battle rating for the next turn
afterwards.

Diamond: Increases the battle rating by
+1 when attacking in melee, but at the
cost of having -1 battle rating when
attacked.

Hoplite: The unit stands in place and
gains +2 battle rating, but at the cost of
not being able to move.

Phalanx: The unit gains +2 battle rating
against attackers who charge, skirmish
and in diamond formation, but moves at
...
again if it hasn't spent all of its
movement for that turn.

Turtle: The unit raises its shields up the
air and becomes immune to ranged
attacks, but suffers a penalty of -2 battle
rating against chargers, skirmishers and
diamond formations.

Special Units

Units that may have spellcasters or
psionicist may cast their powers at once
to another unit or centuria, with the
same effects and limitations of magic
and psionics, as well as only being able
to do it in units and centuriae of the
same type. Doing so, however, leaves
them vulnerable to attacks, suffering a
penalty to -3 battle rating if they are
attacked that same turn.
...
1, Roll for initiative: Each side
rolls 1d6.
...
Each side determines battle

rating: Each side rolls 1d6.

5. Losing side checks for
morale

tw

Turns: Mass combat is divided by turns,
unlike regular combats that use rounds
...
The leader of the army must always
check for morale for any unit or centuria
before making orders. If the morale
check fails, instead

retreating, the unit or centuria stay still
or keep their previous order for the rest
of the turn.

Order actions

Once morale has been checked, the
leader make the orders, in the following
order:

1. Movement (If applicable).

2. Formation (If applicable).

3. Attack Target.

Determine Battle Rating

Determine the battle rating of the unit
...
attacks or is defending, they get to
participate in a regular combat
encounter, if they win their army get +1
battle rating that turn.

Metal Equipment:

Metal Equipment grants +1 battle rating
Supplies: Armies without a steady
supply of food and water suffer a penalty
of -2 battle rating and -2 morale.
...
said result as damage against target unit.
Exceptions:

Range Attacks: The defending side
doesn't get to damage the attacker if it
wins.

Flank and rear attacks: If the attack
comes from the rear of the flanks, the
defender doesn't apply damage back.

Losing Side Checks Morale

Losing side checks morale, if the check
fails, the morale rating decreases by 1. If
a unit of centuria fails its morale check
three times in battle, it will lose
cohesion and flee from the battlefield.
...
Monsters are described by the following
statistics.
...
The number of d8s rolled to determine
an individual’s hit points.

Asterisks: One or more asterisks after
the HD number indicate the number of
special abilities the monster has, for the
purpose of XP calculation (see p228).
Modifiers: Modifiers to the HD (e.g. +3,
-1) are applied to the hit point total after
rolling the specified number of d8s.
...
(with NH indicating that it saves as a
normal human). This is not always equal
to the monster’s HD rating-unintelligent
monsters typically save at half their HD
rating; magical monsters may save at a
higher HD rating.

Some monsters save as a character class.
In this case, the class and level are listed
in parentheses after the saving throw
values:

Attack Roll “to Hit AC 0” (THACo)
The monster's ability to hit foes in
combat, determined by its Hit Dice (see
Monster THACo by Hit Dice, p125).
Attack bonus: The monster's attack
bonus (required when using the optional
tule for Ascending AC) is listed
afterwards in square brackets.
Movement Rate (MV) The speed at
which the monster can move. Every
...
The monster’s likelihood to persist in
battle. See in Classic Fantasy Morale,
pi23.

Alignment (AL)

The monster’s affiliation to Law,
Neutrality, or Chaos. If “any” is listed,
the referee may roll randomly or choose
the creature’s alignment.

XP Award (XP)
Pre-calculated XP reward for defeating
the monster.

Number Appearing (NA)

Listed as two values, the second in

parentheses.

Zeros: If the first value is a zero,

monsters of this type are not usually

encountered in dungeons. If the second

value is a zero, monsters of this type are

not usually encountered in the

wilderness and do not usually have lairs.
...
> Wandering monsters ina
dungeon: The first value
determines the number of monsters
encountered roaming in a dungeon
level equal to their HD. If the
monster is encountered on a level
greater than its HD, the number
appearing may be increased; if
encountered on a level less than its
HD, the number appearing should
be reduced.
> Monster lair in a dungeon: The

second value lists the number of
monsters found ina lair in a
dungeon.

> Wandering monsters in the
wilderness: The second value
indicates the number of monsters
encountered roaming in the
wilderness.

> Monster lair in the wilderness:
The second value multiplied by 5
indicates the number of monsters
...
amount and type of treasure possessed

by the monster(s) (see Treasure Types,

Old School Essentials). The letters listed

are used as follows:

> Ato O: Indicate a hoard: the sum
wealth of a large monster or a
community of smaller monsters,
usually hidden in the lair. For
monsters with a lair encounter size
(see Number Appearing) of greater
than 1d4, the amount of treasure in
the hoard may be reduced, if the
number of monsters is below
average.
> P to V: If listed for an intelligent

monster, indicate treasure carried
by individuals (P to T) or a group
(U, V). If listed for an unintelligent
monster, indicate treasure from the
...
creature's innate psionic abilities. Listed

are the powers or wild talents the

monster is able to cast as well as the

number and rank.

Wild Talents (WT): Wild Talents may

optionally be used at the discretion of
...
These great cats are gifted with psionic
powers that they use to stalk prey. Like
all cats, they prefer to kill with their
natural weapons.

Psionic Cat

Feline creatures which are dark green in
color and have black or yellowish-brown
vertical striping. Growing to a length of
7, they can weigh over 250 pounds.

AC 6[14], HD 4+2 (20 hp), Att 3 x claws
(1d4 by claws), Thaco 17[+2] MV 50’,
SV Dio Wu P12 B13 S14 (4), ML 7, AL
Neutral, XP 375, NA 1(1d4), TT Nil

PSI: Domination, ESP,
Invisibility WT: Life Detection,
All-Round Vision, Know
Direction, Life Detection
Powers: 10 Rank: 2nd
Pursuit: Always pursue prey
that flees.

Favored prey: Often develop a
taste for a certain type of meat
(this may include humans!),
...
The kirre is one of the more vicious
animals of the forests and jungles of
Athas. Resembling a tiger in many ways,
the kirre is a beast not to be trifled with.

AC 6[14], HD 6+6 (33 hp), Att 4 x claws
(1d4+2 by claws), Thaco 13[+6] MV 55;
SV Dio Wu Piz B13 S14 (6), ML 9, AL
Neutral, XP 700, NA1(1), TT Nil

PSI: Levitation, Telekinesis,
Kinetic Leap, Thought Shield,
Invisibility, Crush Life WT: Life
Detection, All-Round Vision,
...
Drakes are gargantuan, reptilian
monsters that use Athas as their
personal hunting grounds. Drakes
comprise a very powerful,
non-intelligent group of creatures on
Athas. If natural instinct, cunning, and
ferocity were measurable, drakes would
surpass many other creatures.

Innate Psionics: They are feared for
their size, speed, and devastating
abilities in combat, the latter due, in
great part, to their very powerful
psionics.

PSI: Body Control, Cell Adjustment,
...
instance, can find a home virtually
anywhere on Athas, but prefer rocky
areas and mountains to the open sands.
Air drakes, as well, know few limitations,
and can ride the winds from the Ringing
Mountains to the Sea of Silt and beyond
their lairs are usually high in the
mountains. Fire drakes can live in the
arid sands, but are always on the lookout
for volcanoes or hot springs; they'll even
set a forest on fire to bask in the comfort
of the flames for a time. Water drakes
are

the most limited on Athas, preferring
...
Se Horror has up to 10 tentacles
AC 8[12], HD 18 (80 hp), Att 10 x attack from which to attack with, each
(d6 by tentacle), Thaco 7[+12] MV 607, tentacle counts as it’s creature,
SV D2 W3 P4 B3 S6 (18), ML 7, AL following the statistics listed
Neutral, XP 7,000 NA1, TT Nil below:
— Horror Tentacle
...
This section is to describe the list of
monsters present in other campaign
settings that may be compatible with
games in Athas. The descriptions for this
monster can be found in the classic
fantasy rules for Old School
...
Roll 1di2 and look up on the table
...
diz Encounter diz Encounter
1 Basilisk 1 Cyclop
2 Ssurran 2 Roc
3 Snake 3 Ssurran
4 Gith 4 Braxat
5 Human/Demi-human 5 Human/Demi-human
6 Scorpion, giant 6 Rat, giant
7 Inix 7 Jhozal
8 Silt runner 8 Belgoi
9 Cilop 9 Gith
10 Anakore 10 Aaracokra
n Purple Worm n Nightmare beast
12 Cloud ray 12 Drake, Earth
Sandy Wastes, Alternative Rocky Badlands, Alternative
diz Encounter diz Encounter
1 Megapede 1 Cloud ray
2 Rock cactus 2 Drake, fire
3 Thrax A Beetle, giant
4 Sink worm 4 Brrogh
5 Brogh 5 Pterrax
6 Silt runner 6 Desert giant
7 Cat, psionic 7 So-ut
8 Beetle, Giant 8 Belgoi
9 Drake, earth 9 Aaracokra
10 Sand Cactus 10 Id fiend
am Kank u Erdland
2 Drake, fire 12 Drake, Air
...
diz Encounter diz Encounter
1 ‘Tyrannosaurus Rex 1 Mekillot

2 Salamander 2 Sylk wyrm
...
9 Aaracokra 9 Spider, giant
10 Villichi 10 Stirge

u Wyvern n Cactus, rock
12 Drake, Air R Gaj

Mountains, Alternative

Scrub Plains, Alternative

 

diz Encounter diz Encounter
1 Triceratops 1 Drake, Earth
2 Banshee, dwarf 2 Thri-kreen + Tohr-kreen.
3 Cat, psionic 3 B'rogh
4 Id fiend 4 Sand Bride
5 Scorpion, giant 5 Villichi
6 Cloud Ray 6 Human/Demi-human
Yi Tarek 7 Tarek
8 Gith 8 Anakore
9 Ghoul 9 Giant, plain
10 Villichi 10 Basilisk
n Pterosaur u Cactus, rock
12 Drake, Air 12 Gaj
...
diz Encounter diz Encounter
1 Basilisk 1 Nightmare beast
2 Snake, giant 2 Cat, kirre

3 Wyvern 3 Pterran

4 Sand Bride 4 Halfling

5 Skeleton 5 Gith

6 Scorpion, giant 6 Pterrax

7 Silt Runner 7 Spider, giant
8 Roc 8 Cat, psionic
9 Centipede, giant 9 Cistern fiend
10 Spider, Giant 10 Beetle, giant
u Cactus, rock n Wyvern

eg Gaj 12 Drake, water

Salt Flats, Alternative Silt Sea

diz Encounter diz Encounter
1 Basilisk 1 Cloud ray
2 Id fiend 2 Purple worm
3 Wyvern 3 Silt runner
4 Sand bride 4 Razorwing
5 Megapede 5 Giant, beasthead
6 Erdland 6 Sailor (Pirate)
Gi Silt Runner 7. Demi-human (trader/pirate)
8 Razorwing 8 Sand bride
9 Centipede, giant 9 Giant, plain

10 Purple worm 10 ‘Trader

un Brogh ns“ Pterrax

12 Drake, fire 2 Silt horror
...
Athas is a living world, and the struggle
for survival is a challenge that almost all
of Athas inhabitants face. The following
...
Monster Complication

The table below describes possible
complications the monsters may be
facing. These shall be rolled at the DMs
discretion with the intent of adding
depth to an encounter.

Monster Complications

2d6 Monster suffers from...
...
Broken Equipment/Attacking limb
Wounded (minor injuries)
Tied/Trapped
...
10 Lacking eyes/ears

u Having spent special abilities

122 Fatally wounded (major injuries)
...
Since Athas is a metal-poor-world, the
treasure tables found in Old School
Essentials™ are inappropriate for coins
found ina lair. The DM may use these
tables instead for all Dark Sun treasure.

Rolling Randomly

Monster listings note which treasure
type is present in the creature's lair and
which it may carry on its person. Each
treasure type (see overleaf) lists one or
more types of coins or items that may be
found in the hoard. For each item in the
list:

Individual and Small Lair Treasure Table

1. Ifa percentage value is given, first roll
dioo to see whether this item is present
in the hoard.

2. If a range of values is given (e.g.
100-1,000cp, 6d6 gems), decide upon
that range to determine the quantity of
this item that is present in the hoard.
...
If the value of the randomly generated
treasure is significantly above or below
the average value of the treasure type,
the referee may adjust the results
manually.
...
Treasure Ceramic Bronze Gold
Type Bits Pieces Pieces Pieces Gems _ Valuable Item
J 242 - - - - - -
K 2-12 -
L = - 510 - 2-8 - -
M - - 612 1-6 - - -
...
x - - - - - - Any 2 potions
Y - - 200-800 - -
Z 100-300 100-400 100-500 100-600 100-400 110 Any3
50% 50% 50% 50% 60% 75% 50%
...
Valuable Items is a denomination for
items of high utility whose properties
ensure superiority of their users while
adventuring. By all intents and purposes,
valuable items work the same as magic
items, but the terminology is changed to
also include Masterwork Weapons and
Metal weapons and armor (details found
in equipment p.14).
...
Rings, Rods, Staves, Wands, and
Miscellaneous Magic: These items
function just as described in Old School
Essentials™. Such items rarely consist
of metal, but rather are fashioned from
the finest alternate materials available.

Armor and Shields: Substitute the
following table for the one present in
Old School Essentials™. Unless the
material is listed, the DM may choose
...
loot have a 25% of being a master
work, 5% of being made of metal and
1% of being made of steel. For magical
weapons, all of them found as part of a
treasure are metal or have metal
components. Nonmetal weapons can be
enchanted as well, but magical
adjustments must still take into account
the inherently poorer quality of the
material used. Weapons are determined
...
These new magical items can be found
as part of lair treasures in Dark Sun.
Because they do not appear in Old
School Essentials™, the DM may grant
them if it is applicable or convenient for
the campaign.

Amulet of Psionic Interference

This item scrambles the wearer's psionic
abilities, making casting psionic powers
or wild powers more difficult.

e Casting Psionics: Instead of
casting an intended power, a
different one is casted, picked
by the DM.

e Removing it: Only the person
who places the amulet around
someone's neck can remove it,
unless supernatural means of
removal are found.

Ring of Life

The ring of life also bestows upon its
wearer recuperative powers within or
around them.

e Land healing: 1 time per day,
the ring is able to heal defiled
land ina 5’ radius around the
wearer.

e Improved healing: After a
complete bed rest, the wearer
recovers 1d3 extra hit points.

Rod of Divining

This item is a small "Y " shaped stick
that must be held in both hands to use.
With each charge expended this item
will locate and pull its holder toward any
accumulation of water of at least one
gallon within 1,000 yards.

e Water Priority: If multiple
accumulations of water reside in
the rod's range, it draws itself to
the largest one.
...
powerful healing energies and
properties.

e Land healing: Pouring a vial on
defiled land will heal an area of
5x5.

e Healing: Consuming it will heal
1d6+6 hit points, as well as all
ailments or diseases (Not
curses)

e Damaging Undead: Throwing
it at undead creatures will cause
them 2d8 damage.
...
Ring of Psionic Defense

Wearer’s of this ring receive a special
protection against mental attacks,
protecting them.

e Mental Defense Bonus: The
ring grants a bonus on all saving
throws against Psionic Powers.
Most rings grant a +1 bonus, but
more valuable versions of it may
grant a bonus of up to +5.

Ring of Psionic Mastery

The ring allows the wearer to enhance
certain psionic powers, making said
power to be cast at a higher power.
e Higher Rank: Once per day,
the wearer is able to cast a
group of 1d8 Psionic Powers
(Determined by the DM) at a
higher Rank.

Ring of Psionic Attack

When a Psionic Character wears this
ring, any power that deals damage to an
enemy will be enhanced to deal
improved damage.

e Increased Damage: The ring
grants a bonus on all damage
dealt through a psionic power.
Most rings grant a +1 bonus, but
more valuable versions of it may
grant a bonus of up to +5.

Ring of Silt Walking

This ring enables the wearer to walk on
silt without sinking into it. The wearer's
feet don’t actually touch the silt, always
remaining above the surface.

Ring of Psionic Charge

The wearer of this ring can store psionic
points in the device for future use on a
two-to-one basis.

e  Psionic Charging: Any power
known by the caster may be
stored, as long as he is able to
cast it. Afterwards, the caster
may activate the power without
having spent his own mental
energy. After casting it, the
power is spent.

e Number of Charges:
Depending on the ring, it may
be able to hold idio powers (as
determined by the DM).

e Power Decay: After 1d10 days,
the power would decay and the
charge would banish.

Staff of Desert Travel

This staff is constructed by halflings of
the Ringing Mountains who travel to the
harsher Tyr region, empowered with
various psionic powers (which are
unknown, as the halflings do not share
this information).

e Charges: Up to 20 charges. The
staff becomes useless after
running out of charges.

e Staff Powers:

1. Cast Create Water and Purify
...
3. Detect and identify any
predator around 100 yards.

4. Cast Conjure Lesser
...
Wand of Desert Winds

This device creates a gust of wind strong
enough to pick up sand or dirt particles
and fling them at a designated target.

e Area Affected: The amount of
material affected is 10 cubic feet
per charge expended.

e Damage: 3d6 damage per
charge.

e Charges: When found these

wands have 2d10+20 charges and
cannot be recharged.

Wand of Psionic Detection

Once a charge is expended the wand
indicates to the wielder the presence of
items which use psionic power, or those
under the influence of or using psionic
powers. These wand function on psionic,
not magical power.

Detection range: 30-foot
radius of the wielder.

Wand of Showers

This wand creates storm clouds which
then creates brief rain showers.

Range and Duration: 1d3
turns, affecting an area 100 yards
in diameter.

Rain: The amount of rain
produced by this effect is
minimal, though it can supply
up to six humanoids (or three
humanoids and one half-giant)
with enough water for one day,
provided they have some means
of collecting the water.
Charges: Up to 5di0+20
charges. These wands cannot be
recharged.

Cube of Energy Containment

This device functions comparably to the
psionic power body control, protecting
the possessor from forms of energy such

Wand of Psionic Negation

This device temporarily negates

as electricity, fire, cold or heat.
e Damage Absorption: When
the carrier of the cube receives

activated psionically powered items, or
removes psionic effects from individuals.
...
have all connections with their
person severed.

Charges: The wand can
function once per round, each
negation draining one charge.
The wand cannot be recharged.

damage, the cube takes the
damage instead.

Cube Hit Points: 200

When HP go to o: When the
cube has 20 hp left, it starts
emanating heat, and when hp
go to o, the cube explodes in a
30’ radius area, dealing 10d10
psionic damage to any creature
...
These magical saddles are used by
travelers to speed their voyages across
the perilous desert. These saddles are
crafted of lizard skin, and fit either
kanks, inix, or crodlu.

e Mount Speed:Once affixed to
the mount, the creature travels
at 150% of its normal movement
rate through desert terrain.

e Resource Consumption: The
creature with this saddle
mounted on will require only
25% of water intake each day.

Bag of Faces

This very unusual item is made from a
thick hide. The owner places the bag
over his head for one full turn, When he
takes it off, he looks like someone else.

e Keeping the Ilusion: The
owner must keep the bag on his
person for it to maintain the
disguise.

e Condition of the Ilusion: The
bag does not change the owner's
body, voice, or mannerisms, this
disguise is only useful with
people that know the imitated
person casually.

Boots of Equilibrium

These boots can vary in color from a
deep red to a dark, mossy green. Those
are the colors of the hej-kin hide used to
make them.

e Psionic Powers: Wearing these
boots allow the wearer to cast
the psionic powers Catfall at will
and Body Equilibrium 1d4 times
per day.

Fire Flute

The fire flute is made from the stem of a
burnflower. When played, the player is
able to control non-magical flames at a
30’ radius, changing their size and shape
or moving them.

Helm of Iron Will

The helm is the rune covered, bony skull
plate of an id fiend. The inside has been
laced with a fine web of iron threads.

e  Psionic Powers: A character
with this helm can use it to cast
the Tower of Iron Will psionic
power, 1d4 times per day, at rank
1 if weared by a non-psionic
character and highest rank if
weared by a psionic character.

Sun Cloak

These cloaks are always some shade of
green and made from a variety of plant
fibers. It grants the power to the wearer
to regain energy through the sun.
e Energy Recovery: For each
turn of lying motionless in the
sun, the cloak heals its wearer 1
hit point.
e Nourishment: A full hour also
eliminates his need for one meal
and half his daily water.

Lyre of Silence

A lyre of silence is a harp-like
instrument that must be strung with the
braided tendons of a bat. When it is
played, it makes no audible sound. It
enables a character to perceive sound
waves visually, by converting the sound
waves to light impulses (it works in
much the same way as feel light).
...
Made from bits of bone sewn together
...
n Aclay painting of a gladiator 36 A jar with tentacles in a green fluid
R A leather amulet with a rune on it 37 Awhistle made of bone
B Avial containing silt 38 An rattle made with a tortoise shell
4 A crystal eye from a crystal spider 39 Ajankx spur
15 Adried hurrum beetle that hums 40 A tooth from a water drake
16 Acoin made our carved carapace 4i An agafari wood needle
7 Small bone doll 42 A bone key of Balican design
18 A rough stone statue of a crodlu B A fetish with dried blood on it
19 Parchment with places names on it “ A broken pterran thanak
20 Bone heartpick with a story carved 45 A wooden toy shaped like a mekillot
a A lock of giant hair 46 A mummified hand of a thrax
22 Asmall wooden halfling statue 47 A holy symbol of a water priest
3 Aring made of agafari wood 48 A sharpened feather
24 A petrified kes'trekel egg 49 A dried head owned by a Nikaal
5 Asmooth dasl cylinder 50 An obsidian orb without a chunk
...
BUSSIaeesgersrsnysnuxsves

Aceramic coin minted by a long dead merchant house
A fire drake scale that is always warm to the touch

An inert Psionicus

A piece of bronze in the form of a bearded dwarf head
A fire drake scale that is always warm to the touch

AG piece of cha'thrang tether

Assmall wooden top, when you spin it you hear the wind
A piece of crystal that lightly vibrates

‘A templar amulet from the city of Kalidnay

Atiny sketch of a small extinct humanoid

An erdlu beak with string tied to it, to make a mask
‘Adried out kank honey globule

Accrystal with a face that bears uncanny likeness to you
Aglass bead, hardened by psionics

Assmall stone box with unknown ashes in it
...
A piece of wax carved with the image of the Grand Vizier
A broken jade disk with the image of a Draji templar
An tooth carved with the image of a halfling village
‘Assmall orange flag with crossed carrikals in black on it
A.gord with dried herbs

Asmall piece of leather which holds pieces of dried sap
Abroken M’Ke trade coin

A dagger given to free a gladiator slave from Tyr
Acracked belgoi's bell

Arusted scale

An Urikite beard ring

A skull of a Pristine Tower warped creature

Awooden box filled with dried leaves from the forest
Asilk veil

A wooden plate with a drawing of the Sunrise Home on it
A small stone statue taken from a building in Nibenay
A flask with water from the Lake of Golden Dreams
Asmall bottle with sand from the Black Sand region

A piece of ceramic with the image of silk skimmer an it
Askull carved from lava rock

Anancient coin from Giustenal

A faded writ of trade from Kurn

A drumstick from the forgotten city of Eldaarich
Astone tablet with names of ancient knights

Aclay tablet with unknown runes on it

A bone plate with images of Ral & Guthay etched on it
A yellow scrap from an Urikite Templar's cloak
Acceramic disk in the shape of the sun

An arrowhead made by a dead elven tribe

Asmall iron hammer made by an ancient dwarven clan
...
Real life cultural inspiration

adi Culture

City Landmarks (roll once per district)
idzo Landmark

 

City Trade Exports (Roll up to four times)
...
Memorial(d4): 1. reflecting pool,
2.mausoleum, 3. large statue, 4. garden
Monument(d4): 1. colossus, 2. column,
3. obelisk, 4. wall
...
toney irrens
Feature dioo Feature Category
Generator oS

During exploration, nature itself 07-15 Hydrography
presents a wide variety and diversity of 16-30 Vegetation
sights and locations, and even a dying
planet like Athas presents an immense
amount of beauty and allure. To quickly
develop what kind of locations a group 70-99
would find, use the following method:

31-45 Ground Feature

46-69 Relief

Rocky Formations

1, Check the biome Sandy Wastes
Biomes will determine the chance of Sandy Wastes
finding certain natural features, check
on one of the following tables depending = 4100 -——“Feature Category
on the biome. Then, roll twice on said
tables to get an idea of what type and 00-07 Hydrography
combination of features PCs are about to 08-15 Vegetation
find. It is good to point out, however, 16-25 Ruins
that locally some types of features 26-60 Ground Feature
denote the presence of another (e.g: 61-99 Relief

vegetation and a settlement clearly
denote the presence of some kind of

hydrography). Rocky Badlands
Verdant Belt Rocky Badlands
Verdant Belt dioo Feature Category
dioo Feature Category 00-01 Settlement
...
Mountains Silt Sea
dioo —_- Feature Category dioo _‘ Feature Category
00-09 Eiiveeeny 00-09 _ Island (Ruins)
10-22 Ruins 10-20 _ Island (Ground Features)

23-43. Ground Feature

44-60 Rocky Formations 035 Hydrography

36-50 Island (Rocky Formations)

61-99 Relief
51-99 Silt
Scrub Plains Forests
Scrub Plains Silt Sea

dioo —_ Feature Category dioo Feature Category

00-06 Settlement 00-09 Settlement

07-14 Hydrography 10-20 Ruins
15-27 Ruins 21-35 Relief
28-60 Vegetation 36-50 Hydrography
61-99 Ground Feature 51-65 Ground Features
66-99 Vegetation
Salt Flats 2. Generate each resulting
Salt Flats feature
dioo Feature Category Features are categorized in settlements,
ruins, vegetation, rocky formations,

00-06 Hydrography hydrography, relief and ground features.
07-13 ‘Vegetation Each category presents its own generator
1420 Ruins to provide detail of the type of feature

one can find out in the wilderness, listed

aes Rocky Formations individually following the next page:

46-99 Ground Features
...
Settlement Oddity Settlement Problem
idiz2_ Oddity idiz_ Problem
1 Odd building materials 1 Vengeful elemental
2 Windy 2 Food/water shortage
3 Tree of life 3 Power Struggle
4 Gambling 4 Elf tribe
5 Old tower 5 Schism
6 — Red-colored water 6 — Undead nearby
7 Strange eating habits 7 ~~ Disease
8 — Unusual pets 8 Bandits
9 Pretty flowers 9 Terrorizing Monster
10 Subterranean rooms 10 Slave trade
u Preparing weddings un __ Nearby city-state
12 One kin makes up most of the 12 Merchant House
population
Settlement Natural Feature Settlement Claim to Fame
idzo Feature idiz2_ Oddity
1 Cliff face 1 Spicy food
2 Quicksand 2 — Strange disappearances
3. Silt Estuary 3 Colourful dyes
4 Cactus field 4 Delicious alcohol
5 Obsidian fied 5 Hidden riches
6 = Mesa 6 Honey
Sarco 7 Suspicion of strangers
8 Ruin 8 — Unusual skills (e. g. metalworking)
9 Intersection of trails/animal runs Sa oeealiy
10 Defiler ground wo Craftsmanship
Suara u Decadence
12 Geyser(s) 12 Fertility of population
13 Mud flat
14 Boulder field
...
Room Oddities/Decorations

 

dioo Oddity dioo Oddity
1 Asmall, scuffed arrowhead painted with green paint, 26 Ametal tankard with two letters engraved on the bottom.
2 Assmall gold coin with the profile of a king etched into it. _27-—_-A.sac filled with bird feathers of every colour imaginable. A
3 Aneffigy of a woman made from interwoven twigs. 28 rapier that never dulls or breaks.

4 Metal rank of insignia of an ancient army. 29 Ahumanoid figure on a stand that changes positions.

5 Three primitive, flint dagger blades. 30 Afire-blackened claw of a huge beast.

6 —_Anidol of man that glows a faint blue in the moonlight. 31 Asmall pillow and blanket filled with bird feathers.

7 Abundle of dried herbs that let out a lovely aroma, 32 Arat preserved in a jar filled with a foul smelling liquid.

8 — Amapof an unfamiliar Land with writing in illegible ink 33 Awhite lace dress that is covered in fresh blood.

9 Ahair brush that when used changes one’s eye colour, 34 Asmall glass container filled with ink.

10 Apreserved skull of a dwarf set upon a wooden altar. 35 _ Alock of long braided blonde hair in a bow! of water

11 Assmall leather bound notebook with crossed names in it 36 stuffed and preserved hand of an old world elf.

12 Apiece of flint and tinder that produce a turquoise flame. 37 A metal tin containing ashes that smell sweet like honey. A
13 Anecklace whose gems change colour based on the mood, 38 Walking cane topped with a metal sculpture of a dragon. A
14 Acharm made from pearls and tide with leather thonging. 39 Ting made from elven silver that fits any finger perfectly. A
15 _Aclub made from an extremely large femur bone. 40 Piece of snake skin with strange designs burned into it. A
16 Awooden toy wolf that can return to its owner's pocket 41 stnall flask filled with green dye that dyes skin

17 Aset of bone dice that screams when rolled. 42 Asmall empty wooden box with a hidden compartment.
18 —_Assmall tin containing fermented cabbage. 43 Anoak divining rod that glows when water is close by.

19 Amirror that makes the looker appear ten years younger, A 44 A wax figure that eerily resembles whoever is holding it.
20 tin of powder that glows when it contact with yourskin.A 45 A leather pouch containing 20 orc teeth.

21 set of simple yellow robes hard to rip or tear, 46 Awooden horse that is only half carved out.

22 Ascarlet rose that always bloom while in its vase. 47 Avial of oil that smells of rotting meat

23 Asmall glass bottle of salt water. 48 Asingle leather boot laced with golden thread.

24 Anartificial stone eye in a glass jar full of blue liquid. 49 Aprism that casts weird shadows when shone into light. 50
25 Asac filled with iridescent scales, cool to the touch. 50 Aglass globe containing a tree, grass and own clouds,
...
Room Oddities/Decorations (Continued)
...
dioo Oddity dioo Oddity
5t —_Anelven statue playing a flute, Sometimes music is heard. ‘Asscroll filled with an elven verse about conquests,
52 Actystal sphere holding an obsidian sword in the center. A A tube that emits a smoke that changes moods if inhaled.
53 _ crown made from ice, cold on touch but never melts, ‘A bag of black beans that provide energy and alertness.
54 Avial of sticky sap A pair of leather shoes that leave red footprints.
55 Aslipof parchment with the words “tam not dead’. A feather that shimmers a bright yellow in the sunlight.
56 Thediary of a travelling bard that is full of terrible verse, A 8A quill that can write on any surface permanently.
57 flask of oil. This is not the Affliction, just black oil, 82 Aset of longs earrings made from seashells.
58 — Abunch of deer antlers tied together in a bundle. 83 Aring that changes colour based on the wearer's mood. A
59 Ametal tin filled with a salve that numbs the skin. 84 flask that changes the taste of whatever liquid is in it,
60 Avial of red liquid warms when danger approaches. 85 Astulfed raven
61 —_Atiny skull with jewelled eyes and seems sentient. 86 Anecklace that gives the wearer a paranoid feeling,
62 Abranch of a tree that catches on fire without burning, 87 A blue piece of leather that is extremely soft to the touch.
63 A burlap pouch full of fingernails. 88 A human scalp with a map tattooed onto the skin.
64 Ablue gemstone shaped like a flame 8 Ascroll that reveals a different Sigil whenever opened.
65 Antarek’s heart, bound in linen, placed in a clay jar 90 Abagof beans that vibrate when near vegetation,
66 —Abracelet created using braided ligaments with charms, 91 _—_Apair of leather gloves that numbs the wearers skin.
67 Afiddle that anyone can play with talent when ill. 92 Aburlap bag that always holds less than it should.
68 Avial of blood insignia etched into it from old royalty 93 —_ Astatuette that resembles a loved one who has died
69 Ajar filled with reptile eyes. 94 Apendant of agolden beetle with red jewels forits eyes.
70 Anempty sword scabbard 95 key witha silver bird as the handle.
7 Avial filled witha viscous green liquid. 96 Awindup music box that plays a familiar tune
rn Ten marbles of many shapes and sizes in wooden box. 7 Asmall book filled with etching of different leaves.
73 Achalice that is always filled with blood. 98 Apadiock that is locked. An mark ofa raven on the lock. A
74 Abuman skull no bigger than a rats skull. 99 vial filled with a liquid metal, ten times its weight
75 Amirror that makes the viewer appear 20 years older. 00 Ashard of obsidian glass that is surrounded by darkness,
...
Rock formations are very common in
Athas, as numerous and diverse as
deserts can be. For generating Rocky

formations, roll on the following tables:

‘Type of Rocky Formation Table
1d6 Formation Type
...
Geological Wonders Table

1d6 Wonder

Fossil rich rock wall

Echo creating rock bed
Labyrinthine Distribution
Geothermal Vents
Glittering Stone Gems
Secret Underground Caves
...
For interesting and odd qualities of the
traversed soil, roll on the following
tables:

Ground Feature Type Table
1d6 Feature Type
...
Ground Point of Interest Table

1d6 Point of Interest

 

Enigmatic Moving Rocks
...
Relief Landmark Table

1d6 Landmark

1 Cloud-touched Peak
Cliff
Mountainous Caverns
...
e The Prism Pentad Series™ (Troy
Denning)

e The Dune Series™ (Frank
Herbert)
