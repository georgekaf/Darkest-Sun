...
- **It is two-way, not one-way.** The intact plate is **hard-paired** with the gate outside Giustenal, and because both are wholly undamaged the route can be activated from **either** end. **This contradicts the dungeon key and the key is the older source.**
- **Cost — see [[Portal Activation]], rewritten to the GM ruling of 10 August 2026:** crush **10 Crystal Dust** to fine powder, mix with water, fill the inscriptions. Ten activates **both** members of a pair from either side; **5 on the origin plus 5 on the destination** does the same. Standing on an activated gate for one round teleports you and **deactivates both**; adding another **5 Crystal Dust** keeps them active, those five being consumed by the one-way trip.
