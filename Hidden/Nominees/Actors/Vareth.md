...
*(New actor. **No `actor-vareth` record exists in mk-sandbox** — verified 2026-08-09 against all 179 actor records. Proposed id `actor-vareth`.)*
...
### Appearance
Slight — STR 5, the weakest character on record in either party. A crude dagger, a backpack, a **wand of web**, and a tarnished elven trade coin he has kept.

### Manner and Voice
Not recorded in detail. INT 16, the highest in the party.

### Public Reputation
In Kharanok, one of the party. In Nibenay, one of Sandira's.
...
- Ambition: High, in the scholarly direction.
- Caution: Necessary — 11 maximum HP.
- Loyalty: **Divided by design**, and it has never cost him anything yet.
- Cruelty: None recorded.
- Risk tolerance: He goes where he is sent.
- Status: **Betrayed by a loved one** (Misery on the sheet).

## Resources and Capabilities
- **Preserver/wizard spellcasting**: **Fireball**, Web, Acid Arrow, Mirror Image, Magic Missile, Mage Armor, Light, Flare, **Blood Rite**, Control Sound.
- **Magic Missile Advantage**, two Spellcasting Advantage talents, +1 on Spellcasting Checks.
- **Learning Spells** — he can add to that list.
- **Wand of Web**.
- Preserving rather than defiling, in a party and a campaign where that distinction is a death sentence in the wrong city.
...
## Knowledge
- Subject: Both campaigns' situations
  - Claim: He is the only character who has current, first-hand knowledge of both Kharanok's party and House Markon's position in Nibenay.
  - Source: direct · Learned day: 116 · Confidence: certain · Truth status: true · Secret: **not marked secret anywhere, which is itself worth checking**

## Current Activity
With the Altar of Dust party, subject to recall by House Markon without notice.
...
- Spells: Fireball, Web, Acid Arrow, Mirror Image, Magic Missile, Mage Armor, Light, Flare, Blood Rite, Control Sound
- Talents: Spellcasting (Wizard), Spellcasting (Preserver), Spellcasting Advantage ×2, Magic Missile Advantage, Learning Spells, +1 on Spellcasting Checks, +2 to Intelligence, Ambitious, Diplomats
- Boon: Misery — betrayed by a loved one
